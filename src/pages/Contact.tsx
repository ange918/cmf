        ...
        <div ref={pageRef}>
            <div
                ...
                <div className="container">
                    <h1>
                        <EnvelopeIcon className="heroicon header-icon" /> Nous
                        Contacter
                    </h1>
                    ...
                    <div className="contact-grid">
                        <div className="contact-form-container fade-in">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="form-group">
                                    <label htmlFor="name">
                                        <UserIcon className="heroicon" /> Nom
                                        complet *
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="form-group">
                                    <label htmlFor="productType">
                                        <CubeIcon className="heroicon" /> Type
                                        de produit
                                    </label>
                                    <select
                                        id="productType"
                                ...
                                <button
                                    ...
                                    style={{ width: '100%' }}>
                                    <PaperAirplaneIcon className="heroicon" />{' '}
                                    {isSubmitting
                                        ? 'Envoi en cours...'
                                        : 'Envoyer la demande'}
                                </button>
                        ...
                        <div className="contact-info-container">
                            <div className="contact-info-card fade-in">
                                <h4>
                                    <IdentificationIcon className="heroicon" />{' '}
                                    Coordonnées
                                </h4>
                            ...
                            <div className="contact-info-card fade-in">
                                <h4>
                                    <ClockIcon className="heroicon" /> Horaires
                                    d'ouverture
                                </h4>
