...
import { InformationCircleIcon, EnvelopeIcon, MapPinIcon, ShieldCheckIcon } from '@heroicons/react/24/outline'
  ...
  return (
    <section className="hero">
      ...
      <div className="hero-highlights">
        ...
        <div className="hero-highlight-card">
          <div className="highlight-icon">
            <svg className="heroicon" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
